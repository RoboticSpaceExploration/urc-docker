...
def Read_RTCM_Data (stream):
		rospy.init_node("ground_station/rtcm_data/raw", anonymous=True)
		rospy.init_node("ground_station/rtcm_data/parsed", anonymous=True)
		rate = rospy.Rate(1)
		rawPub = rospy.Publisher("round_station/rtcm_data/raw", String, queue_size=10)
		parsePub = rospy.Publisher("round_station/rtcm_data/parsed", String, queue_size=10)
